...
export default function NavbarModern() {
  return (
    <>
      <div className="px-3 max-w-screen-xl py-3 mx-auto  min-h-[150px] border-b-2">
...
const Logo = () => {
  return (
    <Link href="/" className="flex items-center space-x-2 text-2xl font-medium text-blueBedri dark:text-gray-100">
        <Image src={LogoImg} alt="Aralsan Logo" width={300} />
    </Link>
  );
};
...
const Hamburger = ({ open }) => {
  return (
    <Disclosure.Button
      ...
      className="px-2 py-1 ml-auto text-blueBedri rounded-md lg:hidden hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-50 focus:outline-none ">
      <svg
...
const MenuItem = ({ item, mobile }) => {
  return (
    <Link href={item?.path ? item.path : "#"} className={cx(
      "text-blueBedri dark:text-blueBedri rounded-md outline-none hover:text-indigo-500 focus:text-indigo-500  transition-all focus-visible:ring-1 ring-indigo-300 dark:focus-visible:bg-gray-800 focus:outline-none",
      mobile
        ...
        <>
          <Menu.Button
            className={cx(
              ...
              open
                ? "text-blueBedri hover:text-blue-500"
                : "text-blueBedri dark:text-gray-300 hover:text-blue-500",
              mobile
                  ...
                  <Menu.Item as="div" key={index}>
                    {({ active }) => (
                      <Link href={item?.path ? item.path : "#"} className={cx(
                        ...
                        active
                          ? "text-blue-500"
                          : "text-blueBedri dark:text-gray-300 hover:text-blue-500 focus:text-blue-500"
                      )}>
